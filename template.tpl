...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Datomni Meta Conversion API",
...
[
  {
    ...
    "subParams": [
      ...
      },
      {
        ...
        "simpleValueType": true,
        "help": "Select the environment for Meta\u0027s Conversion API to ensure non-production data is excluded from production. The environment key is logged for Omni Monitoring and Omni Identity.",
        "valueValidators": [
          {
            "type": "NON_EMPTY"
          }
    ...
    "subParams": [
      {
        ...
        "subParams": [
          ...
          },
          {
            ...
            "help": "Use a custom event name only if none of the standard event names accurately describe your event. Corresponds to the \"event_name\" property in Omni CDI when used with default data mappers."
          },
          {
            "type": "TEXT",
            "name": "eventTimestamp",
            ...
            "help": "Unix timestamp of the event occurrence, required in integer form. Leave blank if unavailable. Corresponds to the \"event_timestamp\" property in Omni CDI when used with default data mappers."
          },
          {
            "type": "SELECT",
            "name": "actionSource",
            ...
            "subParams": [
              {
                ...
                "simpleValueType": true,
                "help": "Boolean value indicating if the user opted out from tracking. If true, ad optimization turns off, and only ad attribution occurs. Corresponds to the \"is_consent_active\" property in Omni CDI when used with default data mappers and Omni Identity with consent enrichment."
              },
              {
                "type": "TEXT",
                "name": "eventId",
                ...
                "subParams": [
                  {
                    ...
                    "help": "Specifies the browser\u0027s URL location of the event. This URL should start with either \"http://\" or \"https://\", which is verified by the tag\u0027s built-in regexp. It must match a domain that has been verified. Corresponds to the \"touchpoint_page_url\" property in Omni CDI when used with default data mappers."
                  }
                ],
                "enablingConditions": [
                  {
                ...
                "subParams": [
                  {
                    ...
                    "simpleValueType": true,
                    "enablingConditions": [],
                    "help": "Name of the page or product tied to the event. If representing the name of the product, then typically used in the context of monetization events. Matches the \"content_name\" property in Omni CDI when used with default data mappers."
                  },
                  {
                    "type": "TEXT",
                    "name": "searchString",
                    ...
                    "help": "Search query made by the user. This property matches the \"touchpoint_page_search_query\" property in Omni CDI when used with default data mappers."
                  },
                  {
                    "type": "TEXT",
                    ...
                    "simpleValueType": true,
                    "enablingConditions": [],
                    "help": "The content category related to the event, either page or the piece of content or product, e.g. \"Grocery\", \"Cars\", \"E-book\". Matches the \"content_category\" property in Omni CDI when used with default data mappers."
                  }
                ],
                ...
                "subParams": [
                  {
                    ...
                    "simpleValueType": true,
                    "help": "Order ID for the transaction and checkout. This corresponds to the \u0027order_id\u0027 property in Omni CDI when used with default data mappers. It is retained throughout the checkout and purchase process.",
                    "enablingConditions": [
                      {
                        "paramName": "eventName",
                  ...
                  },
                  {
                    ...
                    "help": "Monetary value (for purchase or checkout events) or value in a some other metric. Corresponds to the \"order_value\" property in the Omni CDI unified schema when used with default data mappers."
                  },
                  {
                    "type": "TEXT",
                    "name": "currency",
    ...
    "subParams": [
      {
        ...
        "subParams": [
          ...
          },
          {
            ...
            "simpleValueType": true,
            "help": "Last name extracted from the user payload. Matches the \"person_lastname\" property in Omni CDI when used with default data mappers."
          },
          {
            "type": "GROUP",
            ...
            "help": "The value of the user gender extracted from the user payload. This property corresponds to the \"person_gender\" property in the Omni CDI unified schema when used with default data mappers."
          },
          {
            "type": "GROUP",
            ...
            "subParams": [
              {
                ...
                "displayName": "Phone",
                "simpleValueType": true,
                "help": "Raw phone number captured in the event data. Corresponds to the \"person_phone\" property in the Omni CDI unified schema when used with default data mappers."
              },
              {
                "type": "RADIO",
              ...
              },
              {
                ...
                "help": "Determines the value of the country code appearing in the data payload. Corresponds to the \"user_location_country_code\" property in the Omni CDI unified schema when used with default data mappers."
              }
            ]
          },
          {
            ...
            "subParams": [
              ...
              },
              {
                ...
                "simpleValueType": true,
                "help": "References the variable that carries the birthday value in the payload of the event that\u0027s activated by the tag. Corresponds to the \"person_birthdate\" property in the Omni CDI unified schema when used with default data mappers."
              }
            ]
          },
          {
            ...
            "subParams": [
              {
                ...
                "enablingConditions": [
                  {
                    "paramName": "enrichPayloadWithOmniIdentityEmail",
                    "paramValue": false,
                    "type": "EQUALS"
                  },
                  {
        ...
        "subParams": [
          ...
          },
          {
            ...
            "subParams": [
              ...
              {
                "type": "CHECKBOX",
                "name": "isFbcFromJournal",
                "checkboxText": "Enable deep fbc enrichment with Omni Identity",
                "simpleValueType": true,
                "defaultValue": false,
                "enablingConditions": [
                  {
              ...
              {
                "type": "TEXT",
                "name": "fbcLookBackWindow",
                "displayName": "_fbc lookback window",
                "simpleValueType": true,
                "enablingConditions": [
                  {
                    "paramName": "isFbcFromJournal",
          ...
          },
          {
            ...
            "subParams": [
              ...
              },
              {
                ...
                "enablingConditions": [
                  {
                    "paramName": "enrichExtIdwithOmniUnifiedId",
                    "paramValue": false,
                    "type": "EQUALS"
                  }
                ]
...
if (data.tagExecutionEnv === 'dev' || data.tagExecutionEnv === 'local' || data.tagExecutionEnv === 'test') {
    eventData = {
        ...
        client_id: 'xyz2321',
        'x-ga-mp2-data[client_id]': 'xyz2321'
    };
} else {
    eventData = getAllEventData();
}

const TAG_VERSION = "omni-a-gtmss-metaconversionapi-1.32";
...
const isOmniMonitoringEnabled = data.isOmniMonitoringEnabled;
...
// Persistent trace ID for tag execution and activation monitor
...
// Functions for normalizing and hashing properties
...
function daysInMonth(year, month) {
 ...
 function parseISOToUnix(isoString) {
    ...
    const year = makeInteger(dateParts[0], 10);
    const month = makeInteger(dateParts[1], 10) - 1; 
    const day = makeInteger(dateParts[2], 10);

    const hours = makeInteger(timeParts[0], 10);
    const minutes = makeInteger(timeParts[1], 10);
    const seconds = makeInteger(secondsAndMilliseconds[0], 10);
    const milliseconds = makeInteger(secondsAndMilliseconds[1], 10) || 0;
...
// _fbc / _fbp handling from traces (only for Omni Analytics tracking SDK)
...
function prepFbc(fbc) {
    ...
    if (processedFbc && isOmniIdentityResolutionEnabled === true) {
        omniIdentityObject.fbclid = processedFbc;
    }
    return processedFbc;
}
...
function generateOmniIdentityEnrichment(eventPayload) {
    ...
    const identityPayload = {
        platform: 'omni-cdi-activation-gtmss-meta-api',
        valuation_properties: {   
            action: TAG_VERSION + '_' + eventName, 
            properties: eventPayload
        }
      };


    if (!data.isFbcFromJournal) {
        identityPayload.count_prev_visits = true;
    }

    // Add anonymous ID if provided for identity resolution (Omni UUID preferred)
    ...
    let completeIdentityPayload = mergeObjects(omniIdentityObject, identityPayload);

    // logToConsole('Identity payload after merge', identityPayload);

    const identityBody = JSON.stringify(completeIdentityPayload);

    digestLog('Info', 'Identity resolution', 'Omni Identity', {
        message: 'Identity payload: ' + identityBody
    });
    ...
    digestLog('Request', 'Identity resolution', 'Omni Identity', {
        ...
        requestBody: identityBody
    });

    return sendHttpRequest(omniIdentityEndpoint, requestOptions, identityBody)
        .then(response => {
...
function getMatchingClickId(identityResponse) {
    const clientIdPreference = data.fbcTracePosition || "lastTouch"; // Last touch by default
    const clientIdMaximumDuration = makeNumber(data.fbcLookBackWindow) || 90; // maximum period from which client ID's are considered - default 90 days 
    const clientIdMaximumDurationMillis = clientIdMaximumDuration * 24 * 60 * 60 * 1000; 

    const journal = identityResponse.data.journal;

    const now = getTimestampMillis();

    let filteredClickIds = [];


    for (var i = 0; i < journal.length; i++) {

        const journalEntry = journal[i];


        if (journalEntry.fbclid) {

            const createdAtMillis = parseISOToUnix(journalEntry.created_at);

            if (now - createdAtMillis <= clientIdMaximumDurationMillis) {

                filteredClickIds.push({
                    fbclid: journalEntry.fbclid,
                    createdAt: createdAtMillis, // ts in unix format
                    action: journalEntry.valuation_properties.action,
                });
            }
        }
    }

    filteredClickIds.sort(function(a, b) {
        return a.createdAt - b.createdAt;
    });

    // Determine which FB Click ID to return based on your preference
    if (clientIdPreference === "lastTouch") {
        if (filteredClickIds.length > 0) {
            return filteredClickIds[filteredClickIds.length - 1].fbclid; 
        }
    } else if (clientIdPreference === "firstTouch") {
        if (filteredClickIds.length > 0) {
            return filteredClickIds[0].fbclid;  // First touch
        }
    } else if (clientIdPreference === "random") {
        if (filteredClickIds.length > 0) {
            const randomPosition = generateRandom(0, filteredClickIds.length - 1);
            return filteredClickIds[randomPosition].fbclid;  // Randomly selected fbc
        }
    }
...
function applyOmniIdentityEnrichment(response, eventPayload) {
    let identityData = JSON.parse(response.body);

    if (identityData.data && identityData.data.uuid) {
        ...
        if (data.enrichExtIdwithOmniUnifiedId) {
            eventPayload.user_data.external_id = identityData.data.uuid;
        }

        // Check for email in both formats
        let emailToUse = null;
        if (identityData.data.email) {
            // Direct email in data object
            emailToUse = identityData.data.email;
        } else if (identityData.data.journal && identityData.data.journal.length > 0) {
            // Find most recent email from journal
            for (let i = identityData.data.journal.length - 1; i >= 0; i--) {
                if (identityData.data.journal[i].email) {
                    emailToUse = identityData.data.journal[i].email;
                    break;
                }
            }
        }

        if (data.enrichPayloadWithOmniIdentityEmail && emailToUse && !eventPayload.user_data.em) {
            // logToConsole('Enriching with email:', emailToUse);
            eventPayload.user_data.em = hash(emailToUse);
        }

        if (data.isFbcFromJournal) {
            const finalClickId = getMatchingClickId(identityData);
            if (finalClickId) {
                eventPayload.user_data.fbc = finalClickId;
            }
        }

        return eventPayload;
    } else {
        const errorMsg = "UUID not found in response; enrichment failed. Response: " + JSON.stringify(identityData);
        const errorContext = {
            message: errorMsg
        };
        digestLog('Error', 'Identity enrichment', 'Omni Tag', errorContext);
        return Promise.reject(errorMsg);
    }
}
